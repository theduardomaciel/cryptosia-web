...
export default function SectionWrapper({ className, children }: Props) {
	return (
		<div
			className={cn(
				"flex h-full w-full flex-col items-start justify-start py-6 px-6 gap-4 xl:justify-center xl:px-10",
				className
			)}
		>
			{children}
	...
	return (
		...
		>
			...
			<SubsectionButton
				...
				tabIndex={100}
				className={cn("bg-black text-white w-full hover:bg-bg-01", {
